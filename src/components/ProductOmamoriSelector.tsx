        ...
        {omamoris.map((omamori, idx) => {
          ...
          return (
            ...
            >
              ...
              {/* Omamori Image - Click image selects omamori, click zoom button at top corner to zoom */}
              <div
                className="w-full aspect-[4/5] rounded-lg overflow-hidden bg-white mb-1.5 border border-slate-100 flex items-center justify-center relative group/img"
              >
