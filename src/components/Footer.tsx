        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 pb-10 border-b border-slate-800/80">
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            <p className="text-xs text-slate-400 leading-relaxed pr-4">
              Xưởng thủ công chuyên sáng tạo các mẫu vòng tay handmade, móc khóa và phụ kiện thời trang độc bản dành cho giới trẻ và học sinh sinh viên. Mỗi sản phẩm được đan tay chỉn chu, mang dấu ấn cá nhân riêng biệt.
            </p>
